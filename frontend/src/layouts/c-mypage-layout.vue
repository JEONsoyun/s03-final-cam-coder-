    ...
    <div class="c-mypage-layout">
      ...
      <div class="d-flex flex-column c-mypage-layout__content-container">
        <div class="d-flex c-mypage-layout__content">
          <div
            @click="onMenuClick(0)"
            class="d-flex justify-center align-center c-mypage-layout__content-menu1"
            :class="{
              'c-mypage-layout__content-menu--selected': selectedId == 0,
            }"
          >
            학생
          </div>
          <div
            @click="onMenuClick(1)"
            class="d-flex justify-center align-center c-mypage-layout__content-menu2"
            :class="{
              'c-mypage-layout__content-menu--selected': selectedId == 1,
            }"
          >
            선생님
          </div>
          ...
          >
            ...
            <div style="font-size: 12px; color: #868e96; font-weight: 800">
              {{
                selectedId == 0
                  ? '학생 회원 메뉴'
                  : selectedId == 1
