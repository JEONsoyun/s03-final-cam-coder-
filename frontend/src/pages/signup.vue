<template>
  <c-main-layout title="회원가입" noArrow>
    <div class="signup-page">
      <div class="signup-page-top">
        <div class="signup-page-text1">회원가입</div>
        <div class="signup-page-text2">
          간단한 회원가입을 통해 CamCoder의 과외 서비스를 이용해보세요!
        </div>
      </div>
      <div class="signup-page__container">
        ...
        <c-button style="margin-top: 24px" @click="onJoinClick">완료</c-button>
      </div>
    </div>
  </c-main-layout>
</template>
